...
// ? this.commandBus.execute(new CreateUserCommand(dto)) - контроллер не знает кто будет обрабатывать команду. Он просто бросает команду в шину (CommandBus) и говорит: "вот команда, кто умеет — обработай".
