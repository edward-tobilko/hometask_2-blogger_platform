...
import { CreateCommentInputDto } from 'src/modules/bloggers-platform/posts/api/dto/input-dto/create-comment.input-dto';

export const ApiUpdateCommentByIdSwagger = (summary: string) =>
  applyDecorators(
